...
public class Main {
    static private final String ENGINE_SCHEMATIC_FILE_PATH = "Day3/Day3Puzzle1/engine-schematic.txt";
    ...
    public static void main(String[] args) {
        if (!ENGINE_SCHEMATIC_FILE.exists()) throw new RuntimeException("\"" + ENGINE_SCHEMATIC_FILE_PATH + "\" could not be found.");
    ...
    private static void getSchematic() {
        try (BufferedReader br = new BufferedReader(new FileReader(ENGINE_SCHEMATIC_FILE))) {
