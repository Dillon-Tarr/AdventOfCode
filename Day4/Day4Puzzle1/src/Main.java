...
public class Main {
    static private final String CARDS_FILE_PATH = "Day4/Day4Puzzle1/cards.txt";
    static private final File CARDS_FILE = new File(CARDS_FILE_PATH);
    ...
    private static void sumCardPointValues() {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            System.out.println("Card "+(i+1)+": "+points);
